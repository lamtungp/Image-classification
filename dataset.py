...
class Dataset:
    ...
    def generate_sets(self):
        ...
        Returns:
            void
        """
        dataset_classes = glob.glob(self.path + "/train/*")
        i = 0
        ...
        for i in self.get_train_set():
            for j in self.get_train_set()[i]:
                self.classes_descriptors.append(j)
        self.classes_counts = len(self.classes_descriptors)
