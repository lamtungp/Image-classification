...
class Classifier:
    ...
    def train(self, knn_kernel, k, des_name, des_option=constants.ORB_FEAT_OPTION, is_interactive=True):
        """
        ...
        x, y, cluster_model = self.get_data_and_labels(
            self.dataset.get_train_set(), None, k, des_name, isTrain, isTrain, des_option)
    ...
    def test(self, knn, cluster_model, k, des_option=constants.ORB_FEAT_OPTION, is_interactive=True):
        """
